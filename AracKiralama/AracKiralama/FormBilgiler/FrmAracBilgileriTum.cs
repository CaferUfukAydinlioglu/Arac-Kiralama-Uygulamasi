...
{
    public partial class FrmAracBilgileriTum : Form
    {
        int mov;
        int movX;
        int movY;
        ...
        public FrmAracBilgileriTum(FrmArac frmArac)
        {
            InitializeComponent();
            _frmArac = frmArac;
        ...
        private void FrmAracBilgileriTum_Load(object sender, EventArgs e)
        {
